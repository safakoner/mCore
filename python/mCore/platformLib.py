...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    mCore/platformLib.py @brief [ FILE   ] - Platform related classes and functionalities.
## @package mCore.platformLib    @brief [ MODULE ] - Platform related classes and functionalities.
