...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    mCore/displayLib.py @brief [ FILE   ] - Display functionalities.
## @package mCore.displayLib    @brief [ MODULE ] - Display functionalities.
...
class ColorName(mCore.enumAbs.Enum):
...
class DarwinColor(mCore.enumAbs.Enum):
...
class LinuxColor(mCore.enumAbs.Enum):
...
class WindowsLegacyColor(mCore.enumAbs.Enum):
...
#
## @brief [ ENUM CLASS ] - Display color enum class for legacy Windows OS platform.
class WindowsColor(mCore.enumAbs.Enum):
...
class Display(object):
    ...
    #
    #  @param color [ enum | None | in  ] - Any value from mCore.displayLib.ColorName enum class.
    #
    #  @exception N/A
    #
    #  @return str - Color.
    ...
    def getDisplayColor(color):
        ...
        if mCore.platformLib.Platform.isDarwin():
            displayColorClass = DarwinColor

        elif mCore.platformLib.Platform.isWindows10():
